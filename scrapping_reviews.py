...
def get_app_id(game_name):
    ''' Função que recebe como parâmetro o nome de um jogo da plataforma steam e retorna seu número de idêntificação correspondente'''
...
def table_DataBase(list,NomeArq= "NomeArq"):
